-- ====================================================================
-- Al-Qalam (القلم) Tajweed Quiz App - Database Migration v2.0
-- (Halaqat, Quran Audio, Timed Quizzes, Voice Answers, Gemini 3.x)
-- ====================================================================
...
-- 6. NON-RECURSIVE RLS POLICIES FOR HALAQAT
DO $$ BEGIN
...
-- 7. NON-RECURSIVE RLS POLICIES FOR HALAQAH MEMBERS
DO $$ BEGIN
