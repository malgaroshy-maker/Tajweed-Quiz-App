  ...
  return (
    <div className="space-y-8 pb-10">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
          <h1 className="text-4xl font-black tracking-tight text-slate-900 dark:text-slate-100">لوحة المعلم</h1>
          <p className="text-primary/70 mt-2 text-lg font-medium">السلام عليكم ونورتي المعلم {profile?.first_name} {profile?.last_name}</p>
        </div>
